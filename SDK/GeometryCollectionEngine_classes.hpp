...
public:
	...
	TMulticastInlineDelegate<void(const TArray<struct FChaosCollisionEventData>& CollisionEvents)> OnCollisionEvents; // 0x03B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const TArray<struct FChaosBreakingEventData>& BreakingEvents)> OnBreakingEvents; // 0x03C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const TArray<struct FChaosTrailingEventData>& TrailingEvents)> OnTrailingEvents; // 0x03D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const TArray<struct FChaosRemovalEventData>& RemovalEvents)> OnRemovalEvents; // 0x03E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_7F8[0x288];                                    // 0x07F8(0x0288)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UGeometryCollectionComponent) == 0x000AB0, "Wrong size on UGeometryCollectionComponent");
...
static_assert(offsetof(UGeometryCollectionComponent, bForceMotionBlur) == 0x000681, "Member 'UGeometryCollectionComponent::bForceMotionBlur' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, EnableClustering) == 0x000682, "Member 'UGeometryCollectionComponent::EnableClustering' has a wrong offset!");
...
static_assert(offsetof(UGeometryCollectionComponent, bStoreVelocities) == 0x0007D4, "Member 'UGeometryCollectionComponent::bStoreVelocities' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, bShowBoneColors) == 0x0007D5, "Member 'UGeometryCollectionComponent::bShowBoneColors' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, bEnableReplication) == 0x0007D6, "Member 'UGeometryCollectionComponent::bEnableReplication' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, bEnableAbandonAfterLevel) == 0x0007D7, "Member 'UGeometryCollectionComponent::bEnableAbandonAfterLevel' has a wrong offset!");
...
static_assert(offsetof(UGeometryCollectionComponent, DummyBodySetup) == 0x000A80, "Member 'UGeometryCollectionComponent::DummyBodySetup' has a wrong offset!");
static_assert(offsetof(UGeometryCollectionComponent, EmbeddedGeometryComponents) == 0x000A90, "Member 'UGeometryCollectionComponent::EmbeddedGeometryComponents' has a wrong offset!");
