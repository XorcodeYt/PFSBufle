...
static_assert(sizeof(UNavTestRenderingComponent) == 0x000540, "Wrong size on UNavTestRenderingComponent");
...
static_assert(offsetof(ARecastNavMesh, HeuristicScale) == 0x000528, "Member 'ARecastNavMesh::HeuristicScale' has a wrong offset!");
static_assert(offsetof(ARecastNavMesh, VerticalDeviationFromGroundCompensation) == 0x00052C, "Member 'ARecastNavMesh::VerticalDeviationFromGroundCompensation' has a wrong offset!");
