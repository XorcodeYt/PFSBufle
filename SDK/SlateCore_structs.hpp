...
static_assert(sizeof(FEditableTextBoxStyle) == 0x000BA0, "Wrong size on FEditableTextBoxStyle");
...
static_assert(offsetof(FEditableTextBoxStyle, BackgroundColor) == 0x0003CC, "Member 'FEditableTextBoxStyle::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, ReadOnlyForegroundColor) == 0x0003E0, "Member 'FEditableTextBoxStyle::ReadOnlyForegroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, FocusedForegroundColor) == 0x0003F4, "Member 'FEditableTextBoxStyle::FocusedForegroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, HScrollBarPadding) == 0x000408, "Member 'FEditableTextBoxStyle::HScrollBarPadding' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, VScrollBarPadding) == 0x000418, "Member 'FEditableTextBoxStyle::VScrollBarPadding' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, ScrollBarStyle) == 0x000430, "Member 'FEditableTextBoxStyle::ScrollBarStyle' has a wrong offset!");
...
static_assert(sizeof(FInlineEditableTextBlockStyle) == 0x000EF0, "Wrong size on FInlineEditableTextBlockStyle");
...
static_assert(offsetof(FInlineEditableTextBlockStyle, TextStyle) == 0x000BB0, "Member 'FInlineEditableTextBlockStyle::TextStyle' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_F61[0xF];                                      // 0x0F61(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSearchBoxStyle) == 0x000010, "Wrong alignment on FSearchBoxStyle");
static_assert(sizeof(FSearchBoxStyle) == 0x000F70, "Wrong size on FSearchBoxStyle");
static_assert(offsetof(FSearchBoxStyle, TextBoxStyle) == 0x000010, "Member 'FSearchBoxStyle::TextBoxStyle' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ActiveFontInfo) == 0x000BB0, "Member 'FSearchBoxStyle::ActiveFontInfo' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, UpArrowImage) == 0x000C10, "Member 'FSearchBoxStyle::UpArrowImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, DownArrowImage) == 0x000CE0, "Member 'FSearchBoxStyle::DownArrowImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, GlassImage) == 0x000DB0, "Member 'FSearchBoxStyle::GlassImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ClearImage) == 0x000E80, "Member 'FSearchBoxStyle::ClearImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ImagePadding) == 0x000F50, "Member 'FSearchBoxStyle::ImagePadding' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, bLeftAlignButtons) == 0x000F60, "Member 'FSearchBoxStyle::bLeftAlignButtons' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3B71[0xF];                                     // 0x3B71(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FToolBarStyle) == 0x000010, "Wrong alignment on FToolBarStyle");
static_assert(sizeof(FToolBarStyle) == 0x003B80, "Wrong size on FToolBarStyle");
...
static_assert(offsetof(FToolBarStyle, ToggleButton) == 0x001160, "Member 'FToolBarStyle::ToggleButton' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ComboButtonStyle) == 0x001C30, "Member 'FToolBarStyle::ComboButtonStyle' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SettingsButtonStyle) == 0x002230, "Member 'FToolBarStyle::SettingsButtonStyle' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SettingsComboButton) == 0x002620, "Member 'FToolBarStyle::SettingsComboButton' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SettingsToggleButton) == 0x002C20, "Member 'FToolBarStyle::SettingsToggleButton' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonStyle) == 0x0036F0, "Member 'FToolBarStyle::ButtonStyle' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, LabelPadding) == 0x003AE0, "Member 'FToolBarStyle::LabelPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, SeparatorPadding) == 0x003AF0, "Member 'FToolBarStyle::SeparatorPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ComboButtonPadding) == 0x003B00, "Member 'FToolBarStyle::ComboButtonPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, ButtonPadding) == 0x003B10, "Member 'FToolBarStyle::ButtonPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, CheckBoxPadding) == 0x003B20, "Member 'FToolBarStyle::CheckBoxPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, BlockPadding) == 0x003B30, "Member 'FToolBarStyle::BlockPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IndentedBlockPadding) == 0x003B40, "Member 'FToolBarStyle::IndentedBlockPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, BackgroundPadding) == 0x003B50, "Member 'FToolBarStyle::BackgroundPadding' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, IconSize) == 0x003B60, "Member 'FToolBarStyle::IconSize' has a wrong offset!");
static_assert(offsetof(FToolBarStyle, bShowLabels) == 0x003B70, "Member 'FToolBarStyle::bShowLabels' has a wrong offset!");
