...
{
public:
	TMap<struct FUniqueNetIdRepl, class FText>    BanList;                                           // 0x0290(0x0050)(Transient, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AAdvancedGameSession) == 0x0002E0, "Wrong size on AAdvancedGameSession");
static_assert(offsetof(AAdvancedGameSession, BanList) == 0x000290, "Member 'AAdvancedGameSession::BanList' has a wrong offset!");
