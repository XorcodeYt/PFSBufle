...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05690CE0;
	constexpr int32 AppendString      = 0x013DCDB0;
	constexpr int32 GNames            = 0x05864040;
	constexpr int32 GWorld            = 0x05A515E0;
	constexpr int32 ProcessEvent      = 0x0154CCD0;
