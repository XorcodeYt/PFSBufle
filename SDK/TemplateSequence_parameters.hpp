...
static_assert(sizeof(SequenceCameraShakeTestUtil_GetCameraCachePOV) == 0x0007B0, "Wrong size on SequenceCameraShakeTestUtil_GetCameraCachePOV");
...
static_assert(sizeof(SequenceCameraShakeTestUtil_GetLastFrameCameraCachePOV) == 0x0007B0, "Wrong size on SequenceCameraShakeTestUtil_GetLastFrameCameraCachePOV");
...
static_assert(sizeof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache) == 0x0006E0, "Wrong size on SequenceCameraShakeTestUtil_GetPostProcessBlendCache");
...
static_assert(offsetof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache, OutPPBlendWeight) == 0x0006D0, "Member 'SequenceCameraShakeTestUtil_GetPostProcessBlendCache::OutPPBlendWeight' has a wrong offset!");
static_assert(offsetof(SequenceCameraShakeTestUtil_GetPostProcessBlendCache, ReturnValue) == 0x0006D4, "Member 'SequenceCameraShakeTestUtil_GetPostProcessBlendCache::ReturnValue' has a wrong offset!");
