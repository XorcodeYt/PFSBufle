...
{
public:
	TMulticastInlineDelegate<void(int32 TableIndex)> OnTableAltered;                                 // 0x07A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnNumTablesChanged;                                // 0x07B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	TMulticastInlineDelegate<void()>              OnSampleLoaded;                                    // 0x07A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(float ProgressPercent, float ProgressTimeSeconds)> OnSamplePlaybackProgress; // 0x07B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(offsetof(USynthKnob, Locked) == 0x0004E0, "Member 'USynthKnob::Locked' has a wrong offset!");
static_assert(offsetof(USynthKnob, IsFocusable) == 0x0004E1, "Member 'USynthKnob::IsFocusable' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnMouseCaptureBegin) == 0x0004E8, "Member 'USynthKnob::OnMouseCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnMouseCaptureEnd) == 0x0004F8, "Member 'USynthKnob::OnMouseCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnControllerCaptureBegin) == 0x000508, "Member 'USynthKnob::OnControllerCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnControllerCaptureEnd) == 0x000518, "Member 'USynthKnob::OnControllerCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnValueChanged) == 0x000528, "Member 'USynthKnob::OnValueChanged' has a wrong offset!");
